        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                //INSERT YOUR CODE BELOW
                 ...
                 taxRate = 15;
                     ...
                     tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (151900 - 75300 ) * 0.25 + (income - 151900) *0.28;
                     taxRate = 28;
                 }
                 else if (income <= 413350){
                     tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (151900 - 75300 ) * 0.25 + (231450 - 151900) *0.28 + (income - 231450) * 0.33;
                     taxRate = 33;
                 }
                 else if (income <= 466950) {
                     tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (151900 - 75300 ) * 0.25 + (231450 - 151900) *0.28 + (413350 - 231450) * 0.33 + (income - 413350) * 0.35;
                     taxRate = 33;
                 }
                 else {
                     tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (151900 - 75300 ) * 0.25 + (231450 - 151900) *0.28 + (413350 - 231450) * 0.33 + (466950 - 413350) * 0.35 + (income - 466950) * 0.396;
                     taxRate = 39.6;
                 }
          ...
          *******************************************************************************/
              ...
              if (income <= 9275){
                 ...
                 tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                       (74950 - 37650) * 0.25 + (income - 75950) * 0.28;
                 taxRate = 28;
               }//end of else if
          ...
          *******************************************************************************/
                ...
                //INSERT YOUR CODE BELOW
                 ...
                 tax = 13250 * 0.10 + (50400 - 13250) * 0.15 + (130150 - 50400) * 0.25 + (income - 130150) * 0.28;
                 taxRate = 28;
               }//end of else if
               else if (income <= 413350) {
                 tax = 13250 * 0.10 + (50400 - 13250) * 0.15 + (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 + (income - 210800) * 0.33;
                 taxRate = 33;
               }//end of else if
               else if (income <= 441000) {
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 + (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 + (413350 - 210800) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 + (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 + (413350 - 210800) * 0.33 + (441000 - 413350) * 0.35 + (income - 441000) * 0.396;
                  taxRate = 39.6;
               }//end of nested if
